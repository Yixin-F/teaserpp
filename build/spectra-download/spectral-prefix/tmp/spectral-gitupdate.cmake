...
execute_process(
  COMMAND "/usr/bin/git" show-ref "5c4fb1de050847988faaaaa50f60e7d3d5f16143"
  WORKING_DIRECTORY "/home/fyx/fastlio2/src/YOLO-fast-lio-sam/ThirdParty/TEASER-plusplus/build/spectra-src"
...
if("${show_ref_output}" MATCHES "refs/remotes/5c4fb1de050847988faaaaa50f60e7d3d5f16143")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "5c4fb1de050847988faaaaa50f60e7d3d5f16143")
  set(git_remote "${CMAKE_MATCH_1}")
  set(git_tag "${CMAKE_MATCH_2}")
else()
  set(git_remote "origin")
  set(git_tag "5c4fb1de050847988faaaaa50f60e7d3d5f16143")
endif()
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(error_code)
    message(FATAL_ERROR "Failed to fetch repository 'https://github.com/jingnanshi/spectra'")
  endif()
    ...
    if("REBASE" STREQUAL "CHECKOUT")
      ...
      if(error_code)
        ...
        if(NOT "REBASE" STREQUAL "REBASE_CHECKOUT")
          ...
          message(FATAL_ERROR "\nFailed to rebase in: '/home/fyx/fastlio2/src/YOLO-fast-lio-sam/ThirdParty/TEASER-plusplus/build/spectra-src'."
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/home/fyx/fastlio2/src/YOLO-fast-lio-sam/ThirdParty/TEASER-plusplus/build/spectra-src'."
                              "\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
