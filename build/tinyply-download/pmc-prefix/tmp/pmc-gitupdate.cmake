...
execute_process(
  COMMAND "/usr/bin/git" show-ref "0b9fff8e8bd4d37256554fe40cf76b2f3134377b"
  WORKING_DIRECTORY "/home/fyx/fastlio2/src/YOLO-fast-lio-sam/ThirdParty/TEASER-plusplus/build/tinyply-src"
...
if("${show_ref_output}" MATCHES "refs/remotes/0b9fff8e8bd4d37256554fe40cf76b2f3134377b")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "0b9fff8e8bd4d37256554fe40cf76b2f3134377b")
  set(git_remote "${CMAKE_MATCH_1}")
  set(git_tag "${CMAKE_MATCH_2}")
else()
  set(git_remote "origin")
  set(git_tag "0b9fff8e8bd4d37256554fe40cf76b2f3134377b")
endif()
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(error_code)
    message(FATAL_ERROR "Failed to fetch repository 'https://github.com/jingnanshi/tinyply.git'")
  endif()
    ...
    if("REBASE" STREQUAL "CHECKOUT")
      ...
      if(error_code)
        ...
        if(NOT "REBASE" STREQUAL "REBASE_CHECKOUT")
          ...
          message(FATAL_ERROR "\nFailed to rebase in: '/home/fyx/fastlio2/src/YOLO-fast-lio-sam/ThirdParty/TEASER-plusplus/build/tinyply-src'."
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/home/fyx/fastlio2/src/YOLO-fast-lio-sam/ThirdParty/TEASER-plusplus/build/tinyply-src'."
                              "\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
